...
export const users: User[] = [
  { id: 'user-doctor', username: 'doctor1', name: '王乡镇医生', role: 'doctor', orgId: 'org-township', orgName: '青石乡卫生院', phone: '13800000001' },
  { id: 'user-expert', username: 'expert1', name: '陈县医院专家', role: 'expert', orgId: 'org-county', orgName: '云岭县人民医院', phone: '13800000002' },
  { id: 'user-coord', username: 'coord1', name: '刘转运协调员', role: 'coordinator', orgId: 'org-county', orgName: '云岭县人民医院', phone: '13800000003' },
  { id: 'user-admin', username: 'admin1', name: '系统管理员', role: 'admin', orgId: 'org-county', orgName: '云岭县人民医院', phone: '13800000004' },
];
...
export const records: MedicalRecord[] = [
  {
    ...
    presentIllness: '高血压病史10年，否认糖尿病。今晨劳作后突发胸骨后压榨样疼痛。',
    pastHistory: '高血压病史10年',
    temperature: 36.8,
    heartRate: 112,
    systolicBP: 160,
    diastolicBP: 95,
  ...
  },
  {
    ...
    presentIllness: '慢性阻塞性肺病5年。',
    pastHistory: '慢性阻塞性肺病5年',
    temperature: 38.5,
    heartRate: 96,
    systolicBP: 130,
    diastolicBP: 82,
